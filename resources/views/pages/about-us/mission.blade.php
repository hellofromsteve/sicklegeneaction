    ...
    <div class="help-area pt-10 pb-115 ptb-sm-60 ">
        ...
        <div class="container text-center my-2">
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-5 g-4">
                <div class="col">
                    <img src="{{ asset('img/about-us/healthy_baby.jpg') }}" alt="Healthy Baby" class="img-fluid rounded shadow-sm">
                </div>
                <div class="col">
                    <img src="{{ asset('img/about-us/healthy_young.jpg') }}" alt="Healthy Child" class="img-fluid rounded shadow-sm">
                </div>
                <div class="col">
                    <img src="{{ asset('img/about-us/healthy_teen.png') }}" alt="Healthy Adolescent" class="img-fluid rounded shadow-sm">
                </div>
                <div class="col">
                    <img src="{{ asset('img/about-us/healthy_adult.jpg') }}" alt="Healthy Young Adult" class="img-fluid rounded shadow-sm">
                </div>
                <div class="col">
