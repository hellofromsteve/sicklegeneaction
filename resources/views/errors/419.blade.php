<x-layout title="419 - Page Expired">

    <div class="about-us-section py-5 bg-light text-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-danger mb-2">Error! 419</h1>
                    <h3 class="fw-bold mb-20 text-black">Page Expired</h3>
                    <p class="text-secondary mb-4">Your session has expired. Please refresh and try again.</p>
                    <div class="mt-30">
