    ...
    <div class="about-us-section py-5 bg-light text-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-danger mb-2">Error! 500</h1>
                    <h3 class="fw-bold mb-20 text-black">Something Went Wrong</h3>
                    <p class="text-secondary mb-4">We’re working to fix the issue. Please try again later.</p>
                    <div class="mt-30">
