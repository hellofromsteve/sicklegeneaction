<x-layout title="401 - Unauthorized">

    <div class="about-us-section py-5 bg-light text-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-danger mb-2">Error! 401</h1>
                    <h3 class="fw-bold mb-20 text-black">Unauthorized Access</h3>
                    <p class="text-secondary mb-4">You don’t have permission to view this page.</p>
                    <div class="mt-30">
